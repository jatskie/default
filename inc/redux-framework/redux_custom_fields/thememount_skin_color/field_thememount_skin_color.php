...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_thememount_skin_color' ) ) {
	...
	class ReduxFramework_thememount_skin_color{
		...
		public function enqueue() {
			...
			/*wp_enqueue_script(
				'redux-field-thememount-skin-color-js', 
				ReduxFramework::$_url . 'inc/fields/thememount_skin_color/field_thememount_skin_color.js', 
