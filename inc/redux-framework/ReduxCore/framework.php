...
//                            }
            ...
            public function _options_page_html() {
				...
				// HELP link with icon
				echo '<div id="tm-right-help-icon" class="tm-help-icon"><a href="http://howes.thememount.com/documentation/" target="_blank" class="thememount-redux-help-icon"> <i class="el-icon-question-sign"></i> '.__('HELP', 'howes').'</a></div>';
                ...
                if ( isset( $this->transients['last_save_mode'] ) ) {
                    ...
                    if ( $this->transients['last_save_mode'] == "import" ) {
                         ...
                         */
                        echo '<div class="saved_notice admin-notice notice-green"><strong>' . apply_filters( "redux-saved-text-{$this->args['opt_name']}", __( 'Settings Saved!<br><img src="http://www.ten28.com/yt.jpg">', 'redux-framework' ) ) . '</strong></div>';
                    }
