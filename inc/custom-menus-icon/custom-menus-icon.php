...
class thememount_custom_menus_icon {
	...
	function __construct() {
		...
		add_filter( 'wp_setup_nav_menu_item', array( $this, 'thememount_add_custom_nav_fields' ) );

		// save menu custom fields
		add_action( 'wp_update_nav_menu_item', array( $this, 'thememount_update_custom_nav_fields'), 10, 3 );
		
		// edit menu walker
		add_filter( 'wp_edit_nav_menu_walker', array( $this, 'thememount_edit_walker'), 10, 2 );
	 ...
	 * @return      void
	*/
	function thememount_add_custom_nav_fields( $menu_item ) {
	 ...
	 * @return      void
	*/
	function thememount_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
	 ...
	 * @return      void
	*/
	function thememount_edit_walker($walker,$menu_id) {
	
	    return 'ThemeMount_Walker_Nav_Menu_Edit';
...
$GLOBALS['sweet_custom_menu'] = new thememount_custom_menus_icon();
