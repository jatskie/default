...
add_action( 'widgets_init', 'thememount_widget_tabs' );

function thememount_widget_tabs() {
	register_widget( 'thememount_widget_tabs' );
}

class thememount_widget_tabs extends WP_Widget {
	...
	function __construct() {
		$widget_style = array('classname'   => 'thememount_widget_tabs',
		...
		$control_styles = array('width'   => 300,
								'height'  => 350,
								'id_base' => 'thememount_widget_tabs');
		...
		*/
		...
		parent::__construct(
			'thememount_widget_tabs', // Base ID
			__('ThemeMount Tabs Widget', 'howes'), // Name
			$widget_style // Args
		);
	}
	...
	function widget( $args, $cur_instance ) {
		...
		echo '<div class="thememount_widget_tabs_wrapper">'; ?>
	...
	function form( $cur_instance ) {
		...
		<!-- Tab 1 -->
		<p>
			<label for="<?php echo $this->get_field_id( 'tab1'); ?>"><?php echo __('Tab 1 Title', 'howes'); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'tab1' ); ?>"><?php echo __('Tab 1 content', 'howes'); ?>:</label>
		...
		<!-- Tab 2 -->
		<p>
			<label for="<?php echo $this->get_field_id( 'tab2' ); ?>"><?php echo __('Tab 2 Title', 'howes'); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'tab2' ); ?>"><?php echo __('Tab 2 content', 'howes'); ?>:</label>
		...
		<!-- Tab 3 -->
		<p>
			<label for="<?php echo $this->get_field_id( 'tab3' ); ?>"><?php echo __('Tab 3 Title', 'howes'); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'tab3' ); ?>"><?php echo __('Tab 3 content', 'howes'); ?>:</label>
		...
		<!-- Tab 4 -->
		<p>
			<label for="<?php echo $this->get_field_id( 'tab4' ); ?>"><?php echo __('Tab 4 Title', 'howes'); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'tab4' ); ?>"><?php echo __('Tab 4 content', 'howes'); ?>:</label>
		...
		<!-- Tab 5 -->
		<p>
			<label for="<?php echo $this->get_field_id( 'tab5' ); ?>"><?php echo __('Tab 5 Title', 'howes'); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'tab5' ); ?>"><?php echo __('Tab 5 content', 'howes'); ?>:</label>
		...
		<!-- Tab 6 -->
		<p>
			<label for="<?php echo $this->get_field_id( 'tab6' ); ?>"><?php echo __('Tab 6 Title', 'howes'); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'tab6' ); ?>"><?php echo __('Tab 6 content', 'howes'); ?>:</label>
